...
class View:
    ...
    def camioneta_registro(ventana):
        ...
        btn_guardar = Button(ventana, text="Guardar", command=lambda: [
            controller1.Controller.registro_camioneta(
                txt_marca.get(), 
                txt_color.get(), 
                txt_modelo.get(), 
                txt_velocidad.get(), 
    ...
    def camioneta_consultar(ventana):
        ...
        encabezado = "ID | Marca | Color | Modelo | Vel. | Potencia | Plazas | Traccion | Cerrada |\n"
        encabezado += "-" * 80 + "\n"
        txt_consulta.insert(END, encabezado)
    ...
    def camioneta_id(ventana, tipo):
        View.borrarPantalla(ventana)
        accion = "Modificar" if tipo == "cambiar" else "Eliminar"
        lbl_titulo = Label(ventana, text=f"...: Ingresa ID de la Camioneta a {accion} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        if tipo == "cambiar":
            Button(ventana, text="Buscar", command=lambda: View.cambiar_camioneta(ventana, txt_id.get())).pack(pady=10)
        elif tipo == "eliminar":
            Button(ventana, text="Buscar", command=lambda: View.eliminar_camioneta(ventana, txt_id.get())).pack(pady=10)

        btn_regresar = Button(ventana, text="Regresar", command=lambda: View.menu_autos(ventana))
        btn_regresar.pack(pady=10)

    @staticmethod
    def cambiar_camioneta(ventana, id_camioneta):
        View.borrarPantalla(ventana)
        lbl_titulo = Label(ventana, text=f"...: Modificación de Camioneta ID: {id_camioneta} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        lbl_traccion=Label(ventana,text="Nueva Traccion: ",justify="center")
        lbl_traccion.pack(pady=10)
        txt_traccion=Entry(ventana)
        txt_traccion.pack(pady=10)
        ...
        # Llamada al controlador para actualizar
        btn_guardar = Button(ventana, text="Guardar Cambios", command=lambda: [
            controller1.Controller.cambiar_camioneta(
                txt_marca.get(), 
                txt_color.get(), 
                txt_modelo.get(), 
                txt_velocidad.get(), 
    ...
    @staticmethod
    def eliminar_camioneta(ventana, id_camioneta):
        View.borrarPantalla(ventana)
        lbl_titulo = Label(ventana, text=f"...: Eliminar Camioneta {id_camioneta} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        btn_borrar = Button(ventana, text="Confirmar Eliminar", command=lambda: [
            controller1.Controller.borrar_camioneta(id_camioneta), 
            View.menu_camionetas(ventana)])
        btn_borrar.pack(pady=10)
        
        btn_volver = Button(ventana, text="Cancelar / Volver", command=lambda: View.menu_camionetas(ventana))
        btn_volver.pack(pady=10)
    ...
    def camion_registro(ventana):
        ...
        txt_capacidadCarga=Entry(ventana)
        txt_capacidadCarga.pack(pady=10)

        btn_guardar = Button(ventana, text="Guardar", command=lambda: [
            controller1.Controller.registro_camiones(
                txt_marca.get(), 
                txt_color.get(), 
                txt_modelo.get(), 
                txt_velocidad.get(), 
    ...
    def camion_consultar(ventana):
        ...
        encabezado = "ID | Marca | Color | Modelo | Vel. | Potencia | Plazas | Eje | Capacidad de Carga |\n"
        encabezado += "-" * 80 + "\n"
        txt_consulta.insert(END, encabezado)
    ...
    def camion_id(ventana, tipo):
        View.borrarPantalla(ventana)
        accion = "Modificar" if tipo == "cambiar" else "Eliminar"
        lbl_titulo = Label(ventana, text=f"...: Ingresa ID del Camion a {accion} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        if tipo == "cambiar":
            Button(ventana, text="Buscar", command=lambda: View.cambiar_camion(ventana, txt_id.get())).pack(pady=10)
        elif tipo == "eliminar":
            Button(ventana, text="Buscar", command=lambda: View.eliminar_camion(ventana, txt_id.get())).pack(pady=10)

        btn_regresar = Button(ventana, text="Regresar", command=lambda: View.menu_camiones(ventana))
        btn_regresar.pack(pady=10)

    @staticmethod
    def cambiar_camion(ventana, id_camion):
        View.borrarPantalla(ventana)
        lbl_titulo = Label(ventana, text=f"...: Modificación de Camion ID: {id_camion} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        lbl_eje=Label(ventana,text="Nueva Traccion: ",justify="center")
        lbl_eje.pack(pady=10)
        txt_eje=Entry(ventana)
        txt_eje.pack(pady=10)

        lbl_capacidadCarga=Label(ventana,text="Nueva Capacidad de Carga: ", justify="center")
        lbl_capacidadCarga.pack(pady=10)
        txt_capacidadCarga=Entry(ventana)
        txt_capacidadCarga.pack(pady=10)
        ...
        # Llamada al controlador para actualizar
        btn_guardar = Button(ventana, text="Guardar Cambios", command=lambda: [
            controller1.Controller.cambiar_camiones(
                txt_marca.get(), 
                txt_color.get(), 
                txt_modelo.get(), 
                txt_velocidad.get(), 
    ...
    @staticmethod
    def eliminar_camion(ventana, id_camion):
        View.borrarPantalla(ventana)
        lbl_titulo = Label(ventana, text=f"...: Eliminar Camioneta {id_camion} :...", justify="center")
        lbl_titulo.pack(pady=15)
        ...
        btn_borrar = Button(ventana, text="Confirmar Eliminar", command=lambda: [
            controller1.Controller.borrar_camiones(id_camion), 
            View.menu_camiones(ventana)])
        btn_borrar.pack(pady=10)
        
        btn_volver = Button(ventana, text="Cancelar / Volver", command=lambda: View.menu_camiones(ventana))
        btn_volver.pack(pady=10)