...
class View:
    ...
    def menu_principal(ventana):
        ...
        btn_autos=Button(ventana,text="1.- Registro",justify="center",command=lambda: View.registro(ventana))
        btn_autos.pack(pady=15)

        btn_camionetas=Button(ventana,text="2.- Login",justify="center", command=lambda: View.login(ventana))
        btn_camionetas.pack(pady=15)

        btn_camiones=Button(ventana,text="2.- Login",justify="center", command=lambda: View.login(ventana))
